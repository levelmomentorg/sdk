...
to make one handle, then call `ad.show()` in the supplied slot. Wire the one
server-confirmed terminal reward ID and terminal-once resume to the game's supplied hooks. Do not
